...
public class SimpleWebServer extends NanoHTTPD {
    ...
    public SimpleWebServer(String host, int port, File wwwroot, boolean quiet) {
        ...
        super(host, port);
    	System.out.println("sws constructor 1");
        this.quiet = quiet;
    ...
    public SimpleWebServer(String host, int port, List<File> wwwroots, boolean quiet) {
        super(host, port);
    	System.out.println("sws constructor 2");
        this.quiet = quiet;
    ...
    public Response serve(IHTTPSession session) {
    	...
    	System.out.println("serve() called:" + uri);
    ...
    private Response respond(Map<String, String> headers, String uri) {
    	...
    	System.out.println("respond() called: " + uri);
    ...
    Response serveFile(String uri, Map<String, String> header, File file, String mime) {
    	...
    	System.out.println("serveFile() called: " +  uri);
